 ...
 * @author Hélio
 */
public final class AnalizadorSintatico {
    ...
    public AnalizadorSintatico(ArrayList<Token> tokenList, ArrayList<Simbolo> simbolosList, String mensagem) {
        this.tokens = tokenList;
        this.simbolos = simbolosList;
    ...
    public ArrayList<Simbolo> getSimbolos() {
        return new ArrayList<>(this.simbolos);
    }
...
// Declaração de variáveis
    ...
    public void dvar() {
        ...
        if (this.token.getLexema().equals(":")) {
            if (this.tokens.get(this.i - 2).getLexema().equals(",")) {
    ...
    public void variaveisAux() {
        ...
        this.simbolos.get(this.token.getEndereco()).setCategoria("Variável");
        this.lexico();
        if (this.token.getLexema().equals(":")) {
    ...
    public void tipoSimples(boolean array) {
        ...
        if (this.token.getLexema().toLowerCase().equals("integer")) {
            for (int j = 0; j < this.aux.size(); j++) {
                if (array) {
                    this.simbolos.get(this.aux.get(j).getEndereco()).setTipo("[Inteiro]");
                } else {
                    this.simbolos.get(this.aux.get(j).getEndereco()).setTipo("Inteiro");
                }
            }
            ...
            for (int j = 0; j < this.aux.size(); j++) {
                if (array) {
                    this.simbolos.get(this.aux.get(j).getEndereco()).setTipo("[Real]");
                } else {
                    this.simbolos.get(this.aux.get(j).getEndereco()).setTipo("Real");
                }
    ...
    public void procedimento() {
        this.lexico();
        if (this.token.getClasse().equals("cId")) {
            this.simbolos.get(this.token.getEndereco()).setCategoria("Procedimento");
            this.parametros();
            this.lexico();
            if (!this.token.getLexema().equals(";")) {
    ...
    public void funcao() {
        this.lexico();
        if (this.token.getClasse().equals("cId")) {
            this.simbolos.get(this.token.getEndereco()).setCategoria("Função");
            ...
            if (this.token.getLexema().equals(":")) {
                ...
                if (this.token.getLexema().toLowerCase().equals("real")) {
                    this.simbolos.get(this.funcao.getEndereco()).setTipo("real");
                } else if (this.token.getLexema().toLowerCase().equals("integer")) {
                    this.simbolos.get(this.funcao.getEndereco()).setTipo("Inteiro");
                } else {
    ...
    public void listaIdAux() {
        this.aux.add(this.token);
        if (this.simbolos.get(this.token.getEndereco()).getCategoria() != null) { // Verificando se possuem dois identificadores com mesmo lexema, caso existam um é variavel e outro parametro
            Simbolo simbolo = new Simbolo(this.token.getLexema().toLowerCase());
            for (int j = 0; j < this.simbolos.size(); j++) {
                if (this.simbolos.get(j).getLexema().equals(this.token.getLexema()) && this.simbolos.get(j).getCategoria().equals("Parâmetro")) {
                    this.mensagem += "Erro: " + "(" + token.getLinha() + "," + token.getColuna() + ")" + " , Parâmetro já declarado  \n";
                    return;
                }
            }
            simbolo.setEndereco(this.simbolos.size());
            simbolo.setCategoria("Parâmetro");
            this.simbolos.add(simbolo);
            this.token.setEndereco(simbolo.getEndereco());
        } else {
            this.simbolos.get(this.token.getEndereco()).setCategoria("Parâmetro");
        }
        this.lexico();
        if (this.token.getLexema().equals(":")) {
        } else if (this.token.getLexema().equals(",")) {
    ...
    public void comando() {
        try {
            ...
            if (this.token.getLexema().toLowerCase().equals("read")) {
                ...
                this.lexico();
                try {
                    if (this.simbolos.get(this.token.getEndereco()).getCategoria().equals("Variável")) {
                        this.lexico();
                        if (this.token.getLexema().equals(":=")) {
                            this.lexico();
            ...
            } else if (this.simbolos.get(this.token.getEndereco()).getCategoria().equals("Variável") || this.simbolos.get(this.token.getEndereco()).getCategoria().equals("Função")) {
                this.lexico();

                if (this.token.getLexema().equals(":=")) {
                    this.lexico();
                    if (this.simbolos.get(this.token.getEndereco()).getCategoria().equals("Procedimento")) {
    ...
    public void var_read() {
        this.lexico();
        if (this.simbolos.get(this.token.getEndereco()).getCategoria() != null) {
            if (this.simbolos.get(this.token.getEndereco()).getCategoria().equals("Variável")) {
                this.lexico();
                if (this.token.getLexema().equals(",")) {
                    this.var_read();
    ...
    public void expressao() {
        if (this.token.getLexema().equals("+") || this.token.getLexema().equals("-")) {
            ...
            this.termo();
            if (this.token.getLexema().equals("+") || this.token.getClasse().equals("cSub") || this.token.getLexema().equals("*") || this.token.getLexema().equals("/") || this.token.getLexema().toLowerCase().equals("and") || this.simbolos.get(this.token.getEndereco()).getCategoria().equals("Função") || this.token.getLexema().equals("(")) {
                this.lexico();
                this.expressaoAux();
            }
    ...
    public void fator() {
        try {
            if (this.simbolos.get(this.token.getEndereco()).getCategoria().equals("Variável")) {
                this.lexico();
            } else if (this.simbolos.get(this.token.getEndereco()).getCategoria().equals("Função")) {
                this.lexico();
                this.argumentos();
    ...
    public void variavel() {
        ...
        if (this.simbolos.get(this.token.getEndereco()).getTipo().equals("Inteiro") || (this.simbolos.get(this.token.getEndereco()).getTipo().equals("real"))) {
        } else if (this.simbolos.get(this.token.getEndereco()).getTipo().toLowerCase().equals("[Inteiro]") || (this.simbolos.get(this.token.getEndereco()).getTipo().toLowerCase().equals("[Real]"))) {
            this.lexico();
            if (this.token.getLexema().equals("[")) {
                this.lexico();
                this.expressao();
